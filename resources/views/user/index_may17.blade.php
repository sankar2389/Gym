                    ...
                    <div class="container">
                        ...
                        <div class=" col-lg-9 hidden-xs">
                            <ul class="list2">
                                ...
                                <li>
                                    <a href="{{url('/myacc')}}"> <img src="{{ asset('asset/img/user.png') }}" alt="">    <span>Admin</span></a>
                                </li>
                            </ul>
                        </div>
                    </div>
...
@endif
                ...
                <form class="search_box form-inline" id='searchFrm' name='searchFrm' method='post' action="{{url('/gymList') }}">
                    ...
                    <div class="col-sm-3 col-xs-12 ">
                        <input type="text" placeholder="Pincode" class="search_txt"   name='pin' id='pin'>
                    </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
                            <h2 class="section-heading">Offers Near You</h2>
                        </div>  
                    </div>

                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            <img src="{{ asset('asset/img/gallery.jpg') }}" alt="" class="img-responsive">
                        </div>
            ...
            <footer>
                <div class="container">
                    ...
                    <div class="col-md-4 col-sm-2 text-right">
                        <img src="{{ asset('asset/img/logo.png') }}" class="bg_white">
                        <p class="slung white">Fitness & more</p>
                        <ul class="social-network text-center">
                            <li><a href="#"><img src="{{ asset('asset/img/facebook-logo.png') }}" alt="" width="20" height="20"></a></li>
                            <li><a href="#"><img src="{{ asset('asset/img/twitter-logo.png') }}" alt="" width="20" height="20"></a></li>
                            <li><a href="#"><img src="{{ asset('asset/img/instagram-logo.png') }}" alt="" width="20" height="20"></a></li>
                        </ul><br/>
                        <div class="col-sm-12">
                            <p class="white"> (&copy;) Fitbeans sports Limited </p>
                        </div>
                    </div>
                </div>
            </footer>
