...
@media (max-width: 880px) {
    ...
    //$formPostUrl = "https://sandbox.citruspay.com/sslperf/johntest";
     //$formPostUrl = "https://checkout.citruspay.com/ssl/checkout/mwmb90c6c2";    
         $formPostUrl = "https://checkout.citruspay.com/ssl/checkout/fitbeanzlive"; 
     	
    //Need to change with your Secret Key
    $secret_key = "556e33423e971f6106d5e1c68fa3ffc468ad65eb";	        
    //Need to change with your Vanity URL Key from the citrus panel
    //$vanityUrl = "mwmb90c6c2";
	 $vanityUrl = "fitbeanzlive";
    ...
    $returnURL = "http://fitbeanz.com/paymentTestRes";
...
<input type='text' id='merchantTxnId' name='merchantTxnId' value='<?php echo $merchantTxnId; ?>' />
<input type='text' id='orderAmount' class='' name='orderAmount' value='<?php echo $orderAmount; ?>' />
<input type='text' id='currency' name='currency' value='<?php echo $currency; ?>' />
<input type='text' name='returnUrl' value='http://fitbeanz.com/paymentTestRes' />
<input type='text' id='notifyUrl' name='notifyUrl' value='http://fitbeanz.com/paymentTestRes' />
<input type='text' id='secSignature' name='secSignature' value='<?php echo $securitySignature; ?>' />
<input type='text' id='lastName' name='lastName' value='MeenakshiSundram' />


        <!-- <form align="center" method="post" action="<?php echo $formPostUrl ?>">
				 
				 <input type="text" id="merchantTxnId" name="merchantTxnId" value="<?php echo $merchantTxnId ?>" />
				 <input type="text" id="orderAmount" name="orderAmount" value="<?php echo $orderAmount ?>" />
 <input type="text" id="phoneNumber" name="phoneNumber" value="9750134440" />

				 <input type="text" id="firstName" name="firstName" value="bala" />
				 <input type="text" id="email" name="email" value="balasrain@gmail.com" />
				<input type="text" id="currency" name="currency" value="<?php echo $currency ?>" />
<input type="text" name="returnUrl" value="http://fitbeanz.com/paymentTestRes" />
				 <input type="text" id="secSignature" name="secSignature" value="<?php echo $securitySignature ?>" /> -->
