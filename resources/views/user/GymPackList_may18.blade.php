                     ...
                     {  
                         ...
                         for(var i=0; i<data.resultSet.length; i++)
                         {
                            if(data.resultSet[i].price>0){
                             ...
                             pushPrice+="<div class='row'><div class='package_div'><div class='package_name'> "+data.resultSet[i].pack_desc+" </div><div class='rate_box'> Rs."+data.resultSet[i].price+"/per "+perDis+" </div></div>&nbsp;<button class='btn btn-info btn-sm payBtn' lang='"+pricerwId+"'>Buy now</button></div>";
                             ...
                             if(data.getListMinPackage[i].price>0){
                              ...
                              var perDis=data.getListMinPackage[i].pack_desc.split(':')[0];
                               ...
                               var pricerwId=data.getListMinPackage[i].pak_price_id;
                                 pushPrice+="<div class='row'><div class='package_div'><div class='package_name'> "+data.getListMinPackage[i].pack_desc+" </div><div class='rate_box'> Rs."+data.getListMinPackage[i].price+"/per "+perDis+" </div></div>&nbsp;<button class='btn btn-info btn-sm payBtn' lang='"+pricerwId+"'>Buy now</button></div>";
                             }
                         }
