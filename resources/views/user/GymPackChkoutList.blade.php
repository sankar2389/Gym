                  ...
                  if($value->price>0 && $value->pack_desc !="" &&  $value->GymName !="" && $value->UserID>0 && $value->PakName !="" &&  $value->Category !=""  ){
                    ...
                    ?>
                      ...
                      <tr>  
                       ...
                       <tr>  
                           <td> </td>
                           <td><button  type='button' lang='<?php echo $value->pak_price_id;  ?>' class="btn btn-dark btn-sm payLaterBtn">
                                    Pay at Gym</button>&nbsp;<button  type='button' lang='<?php echo $value->pak_price_id;  ?>' class="btn btn-dark    btn-sm payBtn">Razorpay Checkout</button>&nbsp;<button  type='button' lang='<?php echo $value->pak_price_id;  ?>' class="btn btn-dark    btn-sm payBtnCit">Citrus Pay</button></td>
                       </tr>
...
$('.payBtnCit').on( "click", function(event) {
 ...
 if(validator.form()){
     ...
     $('#chkout').attr('action',"{{url('/paymentChkOutfinalcitrus')}}") 
     $("#chkout").submit();
 }
