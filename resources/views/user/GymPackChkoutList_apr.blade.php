...
<section class="details">
    <div class="container">
          ...
          <form id='chkout' name='chkout' method='post' action="{{url('/paymentChkOutfinal')}}" >
                  ...
                  if($value->price>0 && $value->pack_desc !="" &&  $value->GymName !="" && $value->UserID>0 && $value->PakName !="" &&  $value->Category !=""  ){
                    ...
                    ?>
                      ...
                      <tr>  
                       ...
                       <tr>  
                           <td> </td>
                           <td><button  type='button' lang='<?php echo $value->pak_price_id;  ?>' class="btn btn-info btn-sm payBtn">
                                    Checkout
                                    </button></td>
                       </tr>
