                    ...
                    <td bgcolor="#ffffff">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                ...
                                                <table cellspacing="0" cellpadding="0" border="0" width="100%">
                                                    <tr>
                                                        <td valign="top" style="padding: 0 0 5px 0;">
                                                            ...
                                                            <table cellpadding="15" cellspacing="0" border="0" width="100%" align="right" class="responsive-table">
                            <tr>
                                <td colspan="2">
                                    Thank you for your payment process with {{$GymName}}.
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td> {{$cat_name}} <?php if(isset($pack_desc)){ echo $pack_desc;} ?> </td>
                            </tr>
