                                           ...
                                           <td>{{$vals->trans_id}}</td>
                                            ...
                                            <td>&#x20b9;{{$vals->price}} </td> 
                                             <td>{{$vals->pay_result}} </td>
                                              ...
                                              <td><button type="button" lang='{{$vals->cus_pay_id}}' name="pay_{{$vals->cus_pay_id}}" id="pay_{{$vals->cus_pay_id}}" class="btn btn-success btn-fill has-spinner RefundNow" >Refund</button></td>
